...
import { MoreHorizontal, CheckCircle, XCircle, ThumbsUp } from 'lucide-react';
...
interface TestimonialTableProps {
  ...
  onViewItem: (item: Testimonial) => void;
              ...
              <TableCell className="text-right">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="bg-white dark:bg-gray-900">
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem 
                      onClick={() => onModerateItem(item.id, 'approved', 'testimonial')}
                    ...
                    <DropdownMenuItem 
                      onClick={() => onModerateItem(item.id, 'rejected', 'testimonial')}
